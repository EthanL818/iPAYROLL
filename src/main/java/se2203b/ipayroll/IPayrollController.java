...
public class IPayrollController implements Initializable {
    ...
    public void addNewUserProfile() throws Exception {
        ...
        addNewEmployeeProfileController.setDataStore(new UserAccountTableAdapter(false),
                new EmployeeTableAdapter(false), new EarningTableAdapter(false),
                new EarningSourceTableAdapter(false), new DeductionTableAdapter(false),
